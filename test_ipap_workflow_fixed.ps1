...
$testBaseDir = 'D:\test_output'
$testProjectName = '测试项目'
$testSourceDir = 'D:\test_images'
...
if (Test-Path -Path $testSourceDir -PathType Container) {
    Remove-Item -Path $testSourceDir -Recurse -Force -ErrorAction SilentlyContinue
    Write-Host "✅ 测试图片目录已清理" -ForegroundColor Green
}
